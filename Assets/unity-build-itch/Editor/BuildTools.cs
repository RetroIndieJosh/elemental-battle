    ...
    public class BuildTools
    {
        public static void Build( BuildTarget a_target, string a_path, string[] a_scenes, string[] a_extraFiles = null ) {
            ...
            */
            ...
            BuildPipeline.BuildPlayer( a_scenes, a_path, a_target, BuildOptions.None );
...
#else
            Debug.LogError( "Zipping not supported. Define JM_BUILD_ZIP in BuildTools.cs to enable." );
#endif
        }
