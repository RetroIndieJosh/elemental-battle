...
namespace JoshuaMcLean.BuildSystem
{
    ...
    public class BuildWindow : EditorWindow
    {
        ...
        private void Build( BuildTarget a_buildTarget ) {
            ...
            BuildTools.Build( a_buildTarget, buildPath, scenePathList.ToArray(), fileList.ToArray() );
        }
        ...
        private void OnDisable() {
            ...
            EditorPrefs.SetString( "Build Window", data );
        }

        private void OnEnable() {
            var data = EditorPrefs.GetString( "Build Window", JsonUtility.ToJson( this ) );
        ...
        static public void ShowWindow() {
            GetWindow( typeof( BuildWindow ), false, "Build (JM Tools)" );
        }
    }
}
